...
public class TeacherProfile : User
{
    ...
    public TeacherProfile(
        ...
        int? groupId) : base(id, firstName, lastName, dateOfBirth, privateId, email, passwordHash, 3)
    {
        if (groupId.HasValue)
        {
    ...
    // for principal
    public TeacherProfile(
        int id, string firstName, string lastName, DateTime dateOfBirth, string privateId, string email, string passwordHash, int roleId, 
        int? groupId) : base(id, firstName, lastName, dateOfBirth, privateId, email, passwordHash, roleId)
